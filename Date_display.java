...
Program Name    : Write a java program to display the system date and time in various formats shown below:
...
class Date_display
{
	public static void main(String args[])
	{
		...
		formatter = new SimpleDateFormat("w");
		strDate = formatter.format(date);
		System.out.println("Current weak of the year = "+strDate);
		
		formatter = new SimpleDateFormat("W");
		strDate = formatter.format(date);
		System.out.println("Current weak of Month = "+strDate);
